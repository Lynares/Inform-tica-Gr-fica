...
void normal_keys(unsigned char Tecla1,int x,int y)
{
    ...
    if (Tecla1=='P'){modelo.cambiarModo(0); draw_scene();}
    if (Tecla1=='p'){obj2.cambiarModo(0); draw_scene();}
    if (Tecla1=='L'){modelo.cambiarModo(1); draw_scene();}
    if (Tecla1=='l'){obj2.cambiarModo(1); draw_scene();}
    if (Tecla1=='S'){modelo.cambiarModo(2); draw_scene();}
    if (Tecla1=='s'){obj2.cambiarModo(2); draw_scene();}
    if (Tecla1=='A'){modelo.cambiarModo(3); draw_scene();}
    if (Tecla1=='a'){obj2.cambiarModo(3); draw_scene();}
    if (toupper(Tecla1)=='1'){obj1.cambiarPly(); draw_scene();}
    if (toupper(Tecla1)=='2'){obj2.cambiarPly(); draw_scene();}
    if (toupper(Tecla1)=='3'){if(!reposo) modelo.activar(); draw_scene();}
